     ...
     private fun converter(){
        ...
        val checked = selectedCurrency.checkedRadioButtonId
         ...
         val currency = when(checked) {
            ...
            Thread {
                // aqui acontece em pararalelo
               val url = URL ("https://free.currconv.com/api/v7/convert?q=${currency}_BRL&compact=ultra&apiKey=f810954ecf92a91cfae1")
